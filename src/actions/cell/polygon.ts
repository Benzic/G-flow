...
import { Polygon as _Polygon, DisplayObjectConfig, INode, PolygonStyleProps, Group } from '@antv/g'
...
export default class Polygon extends Base {
    ...
    draw(props: DisplayObjectConfig<PolygonStyleProps>): INode {
        const cell: any = new _Polygon(props)
